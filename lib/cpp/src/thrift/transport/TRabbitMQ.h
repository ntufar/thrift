 ...
 *
 */
class TRabbitMQ : public TVirtualTransport<TRabbitMQ> {
public:
  /**
   ...
   */
  TRabbitMQ(std::string host, std::string queue);
   ...
   */
  THRIFT_SOCKET geTRabbitMQFD() { return socket_; }

  /**
   * (Re-)initialize a TRabbitMQ for the supplied descriptor.  This is only
   ...
   */
  void seTRabbitMQFD(THRIFT_SOCKET fd);
...
#endif // #ifndef _THRIFT_TRANSPORT_TRABBITMQ_H_
